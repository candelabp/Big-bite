...
export const AdminBebidas = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (data.imagenBebida && data.imagenBebida.length > 0) {
      ...
      data.urlImagen = selectedBebida ? selectedBebida.urlImagen : "https://firebasestorage.googleapis.com/v0/b/bigbite-55224.appspot.com/o/imagen-producto-default.png?alt=media&token=d6df8d5d-e999-4139-9ac0-b168ce0f316a";
        ...
        <section className="contenedor-formulario">
          ...
          <form className='form-producto' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <input className='input-producto' type="number" min="0" {...register("stock", { required: "El stock es obligatorio" })} />
