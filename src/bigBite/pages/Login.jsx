      ...
      <div>
        ...
        >
          <motion.p
            ...
            transition={{ duration: 1.5, delay: 0.5 }}  // Aparece después de un pequeño retraso
          >
          ...
          <motion.div
            ...
            transition={{ duration: 0.8, delay: 1 }}  // Con un retraso de 1 segundo
          >
            <motion.button
              className="login-btn"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}    // Se reduce al hacer clic
            >
              <Link to="/formulario">Registrarme</Link>
            </motion.button>
          </motion.div>
        </motion.div>
      </div>
