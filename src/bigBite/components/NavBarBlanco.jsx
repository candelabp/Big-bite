            ...
            <ul className={`nav-linkss ${menuAbierto ? 'active' : ''}`} id="nav-linkss">
                ...
                <li>
                    <div className="contPerfil">
                        <i class="bi bi-person-circle iconLogeadoNegro"></i>
                        <h3 className="nombrePerfilNegro">Iniciar Sesion</h3>
                    </div>
                </li>

                <li className="contLinks">
                    <i className="bi bi-house-door"></i>
                    <a href="#" className="tituloLinkNegro">Inicio</a>
                </li>

                <li className="contLinks">
                    <a href="#" className="tituloLinkNegro"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"width="28" height="43" fill="currentColor"><path d="M21 2V22H19V14H16V7C16 4.23858 18.2386 2 21 2ZM9 13.9V22H7V13.9C4.71776 13.4367 3 11.419 3 9V3H5V10H7V3H9V10H11V3H13V9C13 11.419 11.2822 13.4367 9 13.9Z"></path></svg>  Menu</a>
                </li>

                <li className="contLinks">
                    <i className="bi bi-question-circle"></i>
                    <a href="#" className="tituloLinkNegro">Contacto</a>
                </li>
